            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="number"  title="فقط عدد وارد کنید!" class="form-control" name="father_work_phone" v-model="all.father_work_phone">
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="number"  title="فقط عدد وارد کنید!" class="form-control" name="father_id" v-model="all.father_id">
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
            ...
            <div class="row">
                <div class="col-md-2">
                    <div class="form-group">
                        ...
                        <input type="number"  title="فقط عدد وارد کنید!" class="form-control" name="father_birth_day " v-model="all.father_birth_day">
                    </div>
                </div>
                ...
                <div class="col-md-2">
                    <div class="form-group">
                        ...
                        <input type="number"  title="فقط عدد وارد کنید!" class="form-control" name="father_birth_month" v-model="all.father_birth_month">
                    </div>
                </div>
                ...
                <div class="col-md-2">
                    <div class="form-group">
                        ...
                        <input type="number"  title="فقط عدد وارد کنید!" class="form-control" name="father_birth_year" v-model="all.father_birth_year">
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
                        <label>کد بیمه پدر</label>
                        <input type="number"  title="فقط عدد وارد کنید!" class="form-control" name="father_insurance_code" v-model="all.father_insurance_code">
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
                        <label>کد ملی پدر</label>
                        <input type="number"  title="فقط عدد وارد کنید!" class="form-control" name="father_national_code" v-model="all.father_national_code">
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="number"  title="فقط عدد وارد کنید!" class="form-control" name="mother_work_phone" v-model="all.mother_work_phone">
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="number"  title="فقط عدد وارد کنید!" class="form-control" name="mother_id" v-model="all.mother_id">
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
            ...
            <div class="row">
                ...
                <div class="col-md-2">
                    <div class="form-group">
                        ...
                        <input  title="فقط عدد وارد کنید!" type="number" class="form-control" name="mother_birth_day" v-model="all.mother_birth_day">
                    </div>
                </div>
                <div class="col-md-2">
                    <div class="form-group">
                        <label>ماه تولد مادر</label>
                        <input  title="فقط عدد وارد کنید!" type="number" class="form-control" name="mother_birth_month" v-model="all.mother_birth_month">
                    </div>
                </div>  
                <div class="col-md-2">
                    <div class="form-group">
                        <label>سال تولد مادر</label>
                        <input  title="فقط عدد وارد کنید!" type="number" class="form-control" name="mother_birth_year" v-model="all.mother_birth_year">
                    </div>
                </div>
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input  title="فقط عدد وارد کنید!" type="number" class="form-control" name="mother_insurance_code" v-model="all.mother_insurance_code">
                    </div>
                </div>
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input  title="فقط عدد وارد کنید!" type="number" class="form-control" name="mother_national_code" v-model="all.mother_national_code">
                    </div>
                </div>
            </div>
